            ...
            <div class="col-md-8 col-lg-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{url('Update_Data/'.$employee->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <a href="{{url('Update_Data/'.$employee->id)}}"><button type="submit" class="btn btn-primary">Submit</button></a>
                        </form>
                    </div>
                </div>
            </div>
